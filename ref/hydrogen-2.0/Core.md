...
The `Primavera.Hydrogen.Net.Email` provides types that allow sending email messages.
...
The `Primavera.Hydrogen.ComponentModel.DataAnnotations` provides a set of validation attributes that can be used
