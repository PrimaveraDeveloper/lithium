...
- Updated Hydrogen packages to version [2.0.7.347](../hydrogen-2.0#2.0.7.347).
- Updated Hydrogen Design-time packages to version [2.0.0.48](../hydrogen-designtime-2.0#2.0.0.48).
